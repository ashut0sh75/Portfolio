...
const socialMediaLinks = {
  ...
  facebook:
    "https://www.facebook.com/profile.php?id=100010964528173&mibextid=ZbWKwL",
  ...
  projects: [
    {
      ...
      projectDesc:
        "The app is developed as a freelance project for a client. This app is a e - commerce app for a local business.",
      footerLink: [
        {
    ...
    },
    {
      ...
      projectDesc:
        "This app is a camera app which augment an AR filter on face using face recognition technology of unity and also has the ability to store the photos to upload it to firestore and retrieve it using link.",
      footerLink: [
        {
          name: "Visit Project",
